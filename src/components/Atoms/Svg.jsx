...
const Svg = (props) => {
	const svgInfo = {
		...
		seoulAndGyeonggiDoMarker: {
			...
			path:
				'M-22086.5-10596.5v-61.451h-42.889',
			strokeMiterlimit: 10,
			fill: 'none',
		},
		chungnamMarker: {
		...
		userProfile : {
			path : 'M18.1,19.9v-2.3c0.1-2.5-1.8-4.5-4.3-4.6H5.3c-2.5,0.1-4.4,2.2-4.3,4.6v2.3 M14.3,5.6c0,2.6-2.1,4.7-4.6,4.7S5,8.2,5,5.7S7.1,1,9.6,1c0,0,0,0,0,0C12.2,1,14.3,3.1,14.3,5.6z',
